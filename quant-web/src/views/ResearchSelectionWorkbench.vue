...
<template>
  <div class="selection-page">
    <header class="selection-hero">
      <div><p>研究股票池 V1 · 当前时点研究</p><h1>立即选股</h1>
        <span>确定性扫描 {{ universe?.size || 25 }} 只沪深主板股票，前10名进入七智能体深度研究。</span></div>
