...
Write-Output `
    'STOCK_QUANT_FORMAL_ARTIFACT_SET=PRODUCTION,RESEARCH_SELECTION,MAINBOARD_TRADE_CAL_FORWARD_INCREMENT,MAINBOARD_CATCHUP_READONLY_AUDIT,MAINBOARD_DAILY_INCREMENT'
