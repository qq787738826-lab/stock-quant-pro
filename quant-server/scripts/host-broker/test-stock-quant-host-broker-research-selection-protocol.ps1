...
try {
    ...
    foreach ($mutation in @(
            ...
            @('tushare.monthly.calls.before', '120', 'TUSHARE_OVER_BUDGET'),
    ...
    if ([int]$usage.RequestCount -ne 1 -or
        [int]$usage.TushareCalls -ne 52 -or
    ...
    if ([int]$reserved.RequestCount -ne 1 -or
        ...
        [int]$reserved.ReservedTushareCalls -ne 52 -or
        [int]$reserved.CommittedTushareCalls -ne 52 -or
